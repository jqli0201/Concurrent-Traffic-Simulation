...
void WaitingVehicles::permitEntryToFirstInQueue() {
  ...
  // fullfill promise and send signal back that permission 
  // to enter has been granted
...
std::vector<std::shared_ptr<Street>> Intersection
    ::queryStreets(std::shared_ptr<Street> incoming) {
...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle) {
  ...
  // TrafficLight::waitForGreen to block the execution until 
...
void Intersection::setIsBlocked(bool isBlocked) {
  ...
  std::cout << "Intersection #" << _id << " isBlocked=" 
      << isBlocked << std::endl;
}
